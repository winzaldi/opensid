															...
															?>
																<tr>
																	...
																	<td nowrap>
                                                                        ...
                                                                        <?php
//                                                                        if($data['tte']=='N'){
//                                                                           echo '<a href="'.site_url("keluar/tambah_tte/$data[id]").'" class="btn btn-social btn-flat bg-primary btn-sm" title="Tambah ke TTE" target="_blank"><i class="fa fa-key"></i> Tambah TTE</a>';
//                                                                        }else{
//                                                                            echo '<div class="btn btn-social btn-flat bg-success">TTE</div>';
//                                                                        }
                                                                        ?>
